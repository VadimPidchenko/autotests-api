...
class TestExercises:
    def test_create_exercise(
        ...
        request = CreateExercisesRequestSchema(course_id = function_create_course.response.course.id)
    ...
    def test_get_exercise(
        ...
        response = exercises_client.get_exercise_api(function_create_exercise.response.exercise.id)
