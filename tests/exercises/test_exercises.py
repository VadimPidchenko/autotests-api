...
class TestExercises:
    ...
    def test_get_exercise(
        ...
        response = exercises_client.get_exercise_api(
            function_create_exercise.response.exercise.id
        )
    ...
    def test_update_exercise(
        ...
        response = exercises_client.update_exercise_api(
            function_create_exercise.response.exercise.id, request
        )
    ...
    def test_delete_exercise(
        ...
        delete_response = exercises_client.delete_exercise_api(function_create_exercise.response.exercise.id)
        assert_status_code(delete_response.status_code, HTTPStatus.OK)

        get_response = exercises_client.get_exercise_api(function_create_exercise.response.exercise.id)
