...
class AuthenticationClient(APIClient):
    def login_api(self, request: LoginRequestSchema) -> Response:
        ...
        :param request: Объект LoginRequestSchema с email и password.
    ...
    def refresh_api(self, request: RefreshRequestSchema) -> Response:
        ...
        :param request: Объект RefreshRequestSchema с refreshToken.
        :return: Ответ от сервера в виде объекта httpx.Response
        """
        return self.post(
    ...
    def login(self, request: LoginRequestSchema) -> LoginResponseSchema:
        """
        Метод выполняет аутентификацию пользователя, возвращает ответ от сервера в виде объекта LoginResponseSchema.
